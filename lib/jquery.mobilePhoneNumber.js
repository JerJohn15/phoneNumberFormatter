...
(function() {
  var $, browserNotSupported, caretPosition_, checkForCountryChange_, formatBack_, formatForPhone_, formatUp_, format_, formats, formattedPhoneNumber_, formattedPhone_, getNewCaretPosition_, isEventAllowedChar_, isEventAllowed_, mobilePhoneNumber, prefixesAreSubsets_, restrictEventAndFormat_, setCaretPosition_,
    __slice = [].slice;
